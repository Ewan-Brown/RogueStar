...
class ThrusterFixtureSlot(model: Model, transform : Transformation)
    : AbstractFixtureSlot<ThrusterFixture>(model, transform, CollisionCategory.CATEGORY_SHIP, CollisionCategory.CATEGORY_SHIP.bits) {
...
class GunFixtureSlot(model: Model, transform : Transformation,
                     val projectileCreator: (GunFixture) -> AbstractPhysicsEntity)
    : AbstractFixtureSlot<GunFixture>(model, transform, CollisionCategory.CATEGORY_SHIP, CollisionCategory.CATEGORY_SHIP.bits) {
...
class CockpitFixtureSlot(model: Model, transform : Transformation) : AbstractFixtureSlot<CockpitFixture>(model, transform, CollisionCategory.CATEGORY_SHIP, CollisionCategory.CATEGORY_SHIP.bits) {
