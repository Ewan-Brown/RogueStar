...
//            val transform = Transformation3(Vector3(it.position.getX() / 30.0 * scale, it.position.getY() / 30.0 * scale, 0.0), it.scale * scale, it.rotation * PI / 2.0) //TODO Clean up this
//
//            when(it.type){
