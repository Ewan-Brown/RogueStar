...
//            val angleDiff = desiredAngleVec.getAngleTo(angle)
//            return (-angleDiff*8 - angularVelocity*4)
//        }
//
//        private fun calculatePositionalControl(data: PhysicsLayer.PhysicsBodyData, targetPos: Vector2, targetOrientation: Vector2, targetVelocity: Vector2) : Pair<Vector2, Double>{
//            val velocityDiff = targetVelocity - data.velocity
//            val vecToTarget = targetPos - data.position
//
//            val calcThrustToGetTo : (Vector2) -> Vector2 = fun(desiredPosition) : Vector2{
//                val posDiff = desiredPosition - data.position
...
//            var bubbleVelocity = Vector2(0.0, 0.0)
...
//
//                    if (abs(vecToBubbleCenter.getMagnitude()) < radius) {
...
//        }
//
//        val desiredDirection = mousePosProducer() - entityData.position
//
//        actions.add(ControlCommand.TurnCommand(desiredDirection.getAngleTo(0.0)))
