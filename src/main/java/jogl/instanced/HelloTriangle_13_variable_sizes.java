 ...
 * Render stuff things
 */
public class HelloTriangle_13_variable_sizes extends HelloTriangle_Base implements KeyListener {
    ...
    public HelloTriangle_13_variable_sizes() {
        w.setGravity(0, 0);
    }

    public static void main(String[] args) {
        HelloTriangle_13_variable_sizes gui = new HelloTriangle_13_variable_sizes();
        gui.setup(gui);
    }
